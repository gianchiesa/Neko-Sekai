...
class CatRepo {
    ...
    val allBreeds: MutableLiveData<List<AllBreedsItem>> = MutableLiveData()
    ...
    fun getAllBreeds(n: Int): MutableLiveData<List<AllBreedsItem>> {
        val results: MutableList<AllBreedsItem> = ArrayList()
        val observable = catApi.getAllBreeds(n)
